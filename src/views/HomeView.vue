      ...
      <div class="w-full px-4 sm:px-6 lg:px-12 xl:px-16">
        ...
        <div v-else-if="announcements.length > 0" class="space-y-6">
          <article
            ...
            class="md3-card p-6 md:p-8 stagger-item"
          ...
          <div v-if="hasMore && !showAll" class="text-center pt-6">
            <button
              ...
              v-ripple
              class="md3-button-outlined disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
            >
